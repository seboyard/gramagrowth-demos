/* Configuración de cliente. Sólo se edita este archivo.
   Datos: sitio público cabanasriobaker.cl, leído el 2026-09-10.
...
window.RESERVA_CONFIG = {
  ...
  "faq": [
    {
      "pregunta": "¿Cómo se confirma la reserva?",
      "respuesta": "La reserva queda confirmada una vez cancelado el 50% del total."
    },
    {
      "pregunta": "¿A qué hora puedo llegar?",
      "respuesta": "El check in es a partir de las 15:00 y el check out antes de las 12:00. Las salidas más tarde se cobran como día adicional."
    },
    {
      "pregunta": "¿Qué incluye la cabaña?",
      "respuesta": "Dos dormitorios, baño, living, cocina americana equipada, wifi, TV cable y estacionamiento techado."
    },
    {
      "pregunta": "¿Puedo quedarme una sola noche?",
      "respuesta": "Sí. Las estadías de una noche tienen un recargo de $10.000 sobre la tarifa."
    }
  ],
  "atractivos": [
    "Noche Valdiviana",
